...
//    }
    ...
    public ArrayList<Book> queryBook(String sw) {
        String swcx = "%" + sw + "%";
        return (ArrayList<Book>) jdbcTemplate.query(QUERY_BOOK_SQL, new Object[]{swcx, swcx}, new RowMapper<Book>() {
            @Override
    ...
    public ArrayList<Book> jsonToBookList(String swcx) {
       return (ArrayList<Book>) jdbcTemplate.query(QUERY_BOOK_SQL, new Object[]{swcx, swcx}, new RowMapper<Book>() {
           @Override
           public Book mapRow(ResultSet resultSet, int rowNum) throws SQLException {
               Book book = new Book();
    ...
    public ArrayList<Book> queryBookByElasticSearch(String sw) {
        String swcx = "%" + sw + "%";
        GetRequest request = new GetRequest("book",swcx);
...
//    }
    ...
    public ArrayList<Book> getAllBooks() {
        return (ArrayList<Book>) jdbcTemplate.query(QUERY_ALL_BOOKS_SQL, new RowMapper<Book>() {
            @Override
            public Book mapRow(ResultSet resultSet, int rowNum) throws SQLException {
                Book book = new Book();
                book.setPrice(resultSet.getBigDecimal("price"));
...
//    }
    ...
    public Book getBook(Long bookId) {
        String sql = GET_BOOK_SQL;
        Object[] params = {bookId};
        return jdbcTemplate.queryForObject(sql, params, new RowMapper<Book>() {
            @Override
            public Book mapRow(ResultSet resultSet, int rowNum) throws SQLException {
                Book book = new Book();
                book.setAuthor(resultSet.getString("author"));
...
class GetRequest{
    public GetRequest(String a, String b){}
}

class client {


    public static GetResponse get(GetRequest getRequest, BookDao.RequestOptions requestOptions){
