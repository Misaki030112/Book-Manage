...
public class LendDao {
    ...
    public ArrayList<Lend> lendList() {
        return (ArrayList<Lend>) jdbcTemplate.query(LEND_LIST_SQL, new RowMapper<Lend>() {
            @Override
            public Lend mapRow(ResultSet resultSet, int rowNum) throws SQLException {
                Lend lend = new Lend();
...
public ArrayList<Lend> myLendList(int readerId) {
    return (ArrayList<Lend>) jdbcTemplate.query(MY_LEND_LIST_SQL, new Object[]{readerId}, new RowMapper<Lend>() {
        public Lend mapRow(ResultSet resultSet, int rowNum) throws SQLException {
            Lend lend = new Lend();
            lend.setBackDate(resultSet.getDate("back_date"));
            lend.setBookId(resultSet.getLong("book_id"));
