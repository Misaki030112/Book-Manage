...
public class ReaderInfoDao {
    ...
    public ArrayList<ReaderInfo> getAllReaderInfo() {
        return (ArrayList<ReaderInfo>) jdbcTemplate.query(ALL_READER_INFO_SQL, new RowMapper<ReaderInfo>() {
            public ReaderInfo mapRow(ResultSet resultSet, int rowNum) throws SQLException {
